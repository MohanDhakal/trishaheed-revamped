...
class StaffDetail extends StatefulWidget {
  Staff? staff;
  final int? id;
  StaffDetail({Key? key, required this.staff, required this.id})
      : super(key: key);
...
class _StaffDetailState extends State<StaffDetail> {
  ...
  void initState() {
    super.initState();
    if (widget.staff == null && widget.id != null) {
